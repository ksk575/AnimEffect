...
enum {
    ...
    PARAMID_MODE,
    PARAMID_LINE,
    PARAMID_TOPIC_LINE,		// Edge Parameters
    PARAMID_LINESTEP,
    ...
    PARAMID_CANNYTH1,
    PARAMID_CANNYTH2,
    PARAMID_TOPIC_LINE_END,	// Edge Parameters End

    PARAMID_HATCHING,
    PARAMID_TOPIC_HATCHING,	// Hatching Parameters
    PARAMID_PATTERNNO,
    PARAMID_INCLINATION,
    PARAMID_INCRANGE,
    PARAMID_DENSEMAX,
    ...
    PARAMID_TOPIC_HATCHING_END,	// Hatching Parameters
    PARAMID_FREQUENCY,
    PARAMID_MAKEMASK,
    PARAMID_NUM_PARAMS
};
